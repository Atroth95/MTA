...
function class:drawElements () 
	if self.active == true then 
		...
		if self.female == true or self.male == true or self.premium == true then 
...
function class:onClick (btn,state)
	if btn and getKeyState("mouse1") and state then 
		if self.active == true then
			...
			if self.male == true or self.female == true or self.premium == true then 
				if isCursorOnElement(screenX-1600/zoom,220/zoom,420/zoom,55/zoom) then 
					self.male = false
					self.female = false
					self.premium = false 
...
function class:moveDown ()
	if self.active == true then 
		if self.male == true then 
			if self.scroll + self.max >= #maleSkins then 
				self.scroll = #maleSkins 
			return end
			self.scroll = self.scroll + 3
		end
		if self.female == true then 
			if self.scroll + self.max >= #femaleSkins then 
				self.scroll = #femaleSkins 
			return end
			self.scroll = self.scroll + 3
		end 
	end 
